...
** Walking
*** TODO Devise some method of wireless control for testing.
*** TODO Check that the legs are centered and even.
...
** Ultrasonic sensor
*** TODO Mount ultrasonic sensor to the body.
*** TODO Modify ultrasonic code for HC-SR04 sensor.
